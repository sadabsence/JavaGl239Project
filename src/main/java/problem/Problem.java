...
public class Problem {
    ...
    public static final String PROBLEM_TEXT = "ПОСТАНОВКА ЗАДАЧИ:\n" +
            ...
            "Найти такую пару пересекающихся окружностей, что\n" +
            "длина отрезка, проведенного от одной точки пересечения\n" +
            "этих двух окружностей до другой, максимальна.";

    /**
     * заголовок окна
     */
    public static final String PROBLEM_CAPTION = "Итоговый проект ученика 10-3 Оганесяна Степана";
